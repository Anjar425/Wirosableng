    ...
    public void addedToWorld(World world) {
        for (int i : level.hugeWaves) {
            if (i == level.level.length - 1) {
                ...
                int x = 550 - (int) ((double) (i + 1) / (level.level.length) * 428);
                int y = 690 - (int) ((double) (i + 1) / (level.level.length) * 428);
                getWorld().addObject(new Flag(), x, 21);
                getWorld().addObject(new Flag(), y, 21);
            }
    ...
    public void act() {
        ...
        if (level.wave != -1) {
            if (deltaTime > 2000L) {
                ...
                bar.fillRect((int) (428 - 428 * ((double) (level.wave + 1) / level.level.length)), 0,
                        (int) (428 * ((double) (level.wave + 1) / level.level.length)), 14);
                getImage().drawImage(bar, 14, 14);
                bar.setColor(new Color(192, 224, 96));
                bar.fillRect((int) (428 - 428 * ((double) (level.wave + 1) / level.level.length)), 5,
                        (int) (428 * ((double) (level.wave + 1) / level.level.length)), 14);
                getImage().drawImage(bar, 14, 14);
                bar.setColor(new Color(152, 200, 80));
                bar.fillRect((int) (428 - 428 * ((double) (level.wave + 1) / level.level.length)), 7,
                        (int) (428 * ((double) (level.wave + 1) / level.level.length)), 14);
                getImage().drawImage(bar, 14, 14);
                bar.setColor(new Color(128, 184, 64));
                bar.fillRect((int) (428 - 428 * ((double) (level.wave + 1) / level.level.length)), 9,
                        (int) (428 * ((double) (level.wave + 1) / level.level.length)), 14);
                getImage().drawImage(bar, 14, 14);
                bar.setColor(new Color(80, 160, 32));
                bar.fillRect((int) (428 - 428 * ((double) (level.wave + 1) / level.level.length)), 11,
                        (int) (428 * ((double) (level.wave + 1) / level.level.length)), 14);
                getImage().drawImage(bar, 14, 14);
                bar.fillRect((int) (428 - 428 * ((double) (level.wave + 1) / level.level.length)), 13,
                        (int) (428 * ((double) (level.wave + 1) / level.level.length)), 14);
                getImage().drawImage(bar, 14, 14);
            }
