 ...
 */
public class HeroBank extends Actor
{
    /**
    ...
    public EnergyCounter energycounter = new EnergyCounter();
    public HeroPacket[] bank;
    public HeroPacket selectedPacket = null;
    ...
    public HeroBank(HeroPacket[] bank) {
        ...
        if (mouse != null) {
            ...
            if (Greenfoot.mouseClicked(null)) {
                ...
                if (image != null) {
                    if (mouse.getX() < x1 || mouse.getX() > x2 || mouse.getY() < y1 || mouse.getY() > y2) {
                        ...
                        if (MyWorld.board.Board[y][x] == null) {
                            MyWorld.board.placeHero(x, y, selectedPacket.getHero());
                            energycounter.removeEnergy(selectedPacket.energyCost);
                ...
                for (Object i : MyWorld.hitbox.getTouching()) {
                    if (i instanceof HeroPacket) {
                        HeroPacket clicked = (HeroPacket)i;
                        ...
                        if (selectedPacket != clicked) {
                            if (clicked.recharged) {
                                ...
                                AudioPlayer.play(80, "deploy.mp3");
    ...
    public void addedToWorld(World world) {
        ...
        MyWorld.addObject(energycounter, 120, 50);
